<template>
  <div class="grid grid-cols-[1fr_2fr] items-start gap-8">
    <div class="grid grid-rows-[240px_240px] gap-8">
      <article
        class="relative isolate flex h-auto flex-col items-start justify-end overflow-clip rounded-lg border border-black/10 p-8"
        v-for="n in 2"
        :key="n"
      >
        <Icon
          name="heroicons:map-pin"
          class="absolute -bottom-2 -right-8 size-64 text-primary-950/10"
        />
        <h3 class="relative text-2xl">{{ cityName }} – School Name {{ n }}</h3>
        <p class="relative mt-8 text-base">Program Duration</p>
        <p class="relative mt-4 text-base">Program name</p>
      </article>
    </div>
    <svg
      baseprofile="tiny"
      class="min-h-full min-w-full fill-primary-950 stroke-neutral-100"
    ...
    >
      ...
      <g id="points">
        <circle
          class="22.793638273547305|51.8100610685751"
          cx="90.9"
          cy="716.5"
          id="0"
        ></circle>
        <circle
          class="24.17517668344435|54.217206250418755"
          cx="545.5"
          cy="432"
          id="1"
        ></circle>
        <circle
          class="25.902099695815657|56.14292239589368"
          cx="909.1"
          cy="72.1"
          id="2"
        ></circle>
      ...
      <g id="label_points">
        <circle cx="926.9" cy="157.7" id="AEFU"></circle>
        <circle cx="843.4" cy="235.8" id="AESH"></circle>
        <circle cx="889.7" cy="106.9" id="AERK"></circle>
        <circle class="Dubay" cx="762.2" cy="277.8" id="AEDU"></circle>
        <circle class="Abu Dhabi" cx="575.9" cy="574.8" id="AEAZ"></circle>
        <circle class="Umm Al Qaywayn" cx="832.3" cy="154.2" id="AEUQ"></circle>
        <circle class="Ajman" cx="790.7" cy="175.8" id="AEAJ"></circle>
      </g>
    </svg>
  </div>
</template>
...
const myClick = (event) => {
  ...
  activeCity.value = event.target.id;
  cityName.value = event.target.dataset.id;
};
</script>
